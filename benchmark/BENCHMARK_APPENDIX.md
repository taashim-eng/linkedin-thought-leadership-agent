...
**Baseline**: Single-prompt request to GPT-4: _"Write 6 LinkedIn posts about SQL Query Performance for Data Engineers and Business Stakeholders."_
...
_Prompt_: "Write 6 LinkedIn posts about SQL Query Performance for Data Engineers and Business Stakeholders."
...
_Note: Week 5 dropped into generic "leadership strategy" language ("strategic decisions," "operational efficiency goals," "forward-thinking teams") that is inappropriate for kernel engineers. This is the exact failure mode: Skill 4's Manager/Director voice profile replaced precise technical language with executive platitudes._
