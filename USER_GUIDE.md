...
**Date**: February 2026
**Repository**:
<https://github.com/taashim-eng/linkedin-thought-leadership-agent>

---

## Quick Summary

This system takes your topic + domain expertise and produces a polished 6-week
LinkedIn series — with narrative arc, authentic voice, quality scoring, and
optional automated publishing. It takes about 30-60 minutes end-to-end for a
first run.
...
**For Manus AI**: Upload each file in `skills/` via the platform's skill upload
interface.

**For any other LLM**: Copy the skill files into the appropriate directory for
your platform's skill support.
...
The orchestrator will guide you through the rest. Here's what to expect at each
stage:
...
You'll be asked 5 questions. Answer them honestly and specifically — the quality
...
**REVISE**: "Week 2 — Revise: The hook is too generic, make it more provocative.
Try starting with a question that challenges assumptions."
...
**Tip**: Read each post out loud. If it doesn't sound like you, it needs
revision.
...
- Low Narrative Cohesion → check Week 5 or 6
- They're often where arc breakdown happens
...
The system will call `linkedin_create_post` directly. See Setup section for MCP
configuration.
...
**LinkedIn image tip**: These are 1080x1080 optimized. Post as a single image
...
- The narrative arc structure
  (Hook → Framework → Story → Tactics → Vision → Call)
...
- Audiences who are Manager/Director level
  (voice refiner is optimized for this level)
...
- Visionary/trend topics
  (Week 5 is the consistently weak spot — add specific examples)
...
Consistent tone across all 6 posts is important for Voice Consistency scores. If
you must change tone, change it before Stage 3 (before drafts are generated).
After drafts exist, changing tone requires re-running Skills 3-5 for affected
posts.
...
See the README or open an issue:
<https://github.com/taashim-eng/linkedin-thought-leadership-agent/issues>
